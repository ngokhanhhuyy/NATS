...
public class BusinessServiceDetailViewModel
{
    ...
    public List<BusinessServiceFeatureViewModel> Features { get; set; }

    [Display(Name = DisplayNames.Photo)]
    public List<BusinessServicePhotoViewModel> Photos { get; set; }
